...
int count = 0;
pthread_mutex_t count_mutex0, count_mutex1;
...
void *inc_count(void *arg) 
{
  ...
  for (i = 0; i < my_args->printCount; i++) {
    /*
 ...
 *          */
  ...
  /* Initialize mutex */
  pthread_mutex_init(&count_mutex0, NULL);
 ...
 *       */ 
  ...
  pthread_mutex_destroy(&count_mutex0);
